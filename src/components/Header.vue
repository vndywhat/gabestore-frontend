  ...
  <header class='b-header js-header'>
    <div class='b-header__wrapper'>
      ...
      <div class='b-header__container b-header__container--search'>
        <div class='btn btn--header sm-hide js-modal-open' :class='isOpen ? "active" : ""' @click='isOpen = !isOpen' data-modal='menu'>Каталог игр</div>
        <div id='search'></div>
      </div>
      <div class='b-header__icons b-header__container'>
        ...
        <a class='b-header__icon b-header__icon--notification  js-modal-open sm-hide' data-modal='notification'></a><a
        class='b-header__icon b-header__icon--user sm-hide' href='/profile'></a> <a
        class='b-header__icon b-header__icon--favorite sm-hide js-favorite-icon' href='/profile/favorites'></a><a
        class='b-header__icon b-header__icon--cart sm-hide js-cart-icon ' href='/basket'></a>
        <div class='b-header__menu-btn js-modal-open' data-modal='menu'><span></span><span></span><span></span></div>
      </div>
      <div class='b-popup js-modal hide b-popup--small' data-modal='notification' data-id='7264060'
           data-url='/api/notifications-check'><span class='b-popup__overlay'></span>
            ...
            <div class='b-notification'>
              ...
              <div class='b-notification__wrapper'>
                <div class='b-notification__item b-notification__item--viewed'>
                  <div class='b-notification__item-title'>Техподдержка - тоже люди ;)</div>
                  <div class='b-notification__item-description'>Привет! Поддержка магазина отмечает НГ. Можете оставить
                    вопрос в ВК или по почте, а мы начнём отвечать с 16 МСК 01.01.22
                  </div>
                  <a class='b-notification__item-btn' href='https://gabestore.ru/page/support'>Контакты</a>
                </div>
                <div class='b-notification__item b-notification__item--viewed'>
                  <div class='b-notification__item-title'>Конкурс отзывов (до 09.01)</div>
                  <div class='b-notification__item-description'>Оставьте на сайте отзыв на купленную у нас игру —
                    авторам пяти лучших текстов мы подарим по 1000 баллов для GabeStore.
                  </div>
                  <a class='b-notification__item-btn' href='https://vk.com/wall-93893399_1216175'>Подробнее</a>
                </div>
                <div class='b-notification__item b-notification__item--viewed'>
                  <div class='b-notification__item-title'>Серия старая, игра — новая</div>
                  <div class='b-notification__item-description'>Вы же играли в Resident Evil 2 – Deluxe Edition?
                    Продолжите приключения в Resident Evil Village!
                  </div>
                  <a class='b-notification__item-btn' href='https://gabestore.ru/game/resident-evil-village'>Перейти к
                    игре</a>
                </div>
                <div class='b-notification__item b-notification__item--viewed'>
                  <div class='b-notification__item-title'>Как вам игра?</div>
                  <div class='b-notification__item-description'>Почувствуйте себя немного критиком — оцените TEKKEN 7 –
                    Ultimate Edition
                  </div>
                  <a class='b-notification__item-btn' href='https://gabestore.ru/game/tekken-7-ultimate-edition'>Перейти
                    к игре</a>
                </div>
      ...
      <div class='b-popup js-modal hide b-popup--menu' :class='isOpen ? "show" : ""' data-modal='menu'><span
        class='b-popup__overlay'></span>
        <div class='b-popup__container js-custom-scrollbar'>
          <div class='b-popup__content js-modal-content'>
            <div class='b-menu__close js-menu-close'></div>
            <div class='b-menu__icons'>
              <a class='b-header__icon b-header__icon--notification  js-modal-open' data-modal='notification'></a><a
              class='b-header__icon b-header__icon--user' href='/profile'></a><a
              class='b-header__icon b-header__icon--favorite js-favorite-icon' href='/profile/favorites'></a><a
              class='b-header__icon b-header__icon--cart js-cart-icon ' href='/basket'></a>
            </div>
            <div class='b-menu__wrapper js-accordeon-container' data-mobile='true'>
              ...
              <div class='b-menu__accordeon b-menu__col'>
                ...
                <ul class='b-menu__accordeon-list'>
                  ...
                  <li class='b-menu__accordeon-item'><a href='/catalog?ProductFilter%5Bgenre%5D%5B%5D=22'>Ролевые</a>
                  </li>
                  <li class='b-menu__accordeon-item'><a href='/catalog?ProductFilter%5Bgenre%5D%5B%5D=2'>Приключения</a>
                  </li>
                  <li class='b-menu__accordeon-item'><a href='/catalog?ProductFilter%5Bgenre%5D%5B%5D=24'>Стратегии</a>
                  </li>
                  <li class='b-menu__accordeon-item'><a href='/catalog?ProductFilter%5Bgenre%5D%5B%5D=23'>Симуляторы</a>
                  </li>
                  <li class='b-menu__accordeon-item'><a href='/catalog?ProductFilter%5Bgenre%5D%5B%5D=25'>Онлайн</a>
                  </li>
                  ...
                  <li class='b-menu__accordeon-item'><a
                    href='/catalog?ProductFilter%5Bgenre%5D%5B%5D=706'>Казуальные</a></li>
                  <li class='b-menu__accordeon-item'><a href='/catalog?ProductFilter%5Bgenre%5D%5B%5D=1467'>Гонки</a>
                  </li>
                  <ul class='b-menu__list b-menu__list-sub'>
                    <li class='b-menu__list-item'><a href='/catalog'>Все игры — 3065</a></li>
                  </ul>
                </ul>
              </div>
              <div class='b-menu__accordeon b-menu__col'>
                ...
                <ul class='b-menu__accordeon-list'>
                  ...
                  <li class='b-menu__accordeon-item'><a href='/publishers/BANDAI-NAMCO'>BANDAI NAMCO</a></li>
                  <li class='b-menu__accordeon-item'><a href='/publishers/Bethesda-Softworks'>Bethesda Softworks</a>
                  </li>
                  ...
                  <li class='b-menu__accordeon-item'><a href='/publishers/Paradox-Interactive'>Paradox Interactive</a>
                  </li>
                  ...
                  <ul class='b-menu__list b-menu__list-sub'>
                    <li class='b-menu__list-item'><a href='/publishers'>Все издатели — 230</a></li>
                  </ul>
                </ul>
              </div>
              <div class='b-menu__accordeon b-menu__col'>
                ...
                <ul class='b-menu__accordeon-list'>
                  ...
                  <li class='b-menu__accordeon-item'><a href='/developers/Remedy-Entertainment'>Remedy Entertainment</a>
                  </li>
                  <li class='b-menu__accordeon-item'><a href='/developers/Respawn-Entertainment'>Respawn
                    Entertainment</a></li>
                  <ul class='b-menu__list b-menu__list-sub'>
                    <li class='b-menu__list-item'><a href='/developers'>Все разработчики — 1056</a></li>
                  </ul>
                </ul>
              </div>
            </div>
